...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('throws', array(function() { throw new LogicException('tests'); }, 'LogicException'), true),
            array('throws', array(function() { throw new LogicException('tests'); }, 'IllogicException'), false),
            array('throws', array(function() { throw new Exception('tests'); }), true),
            array('throws', array(function() { trigger_error('tests'); }, 'Throwable'), true, false, 70000),
            array('throws', array(function() { trigger_error('tests'); }, 'Unthrowable'), false, false, 70000),
    ...
    public function testAssert($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        if ($minVersion && PHP_VERSION_ID < $minVersion) {
            $this->markTestSkipped(sprintf('This tests requires php %s or upper.', $minVersion));
