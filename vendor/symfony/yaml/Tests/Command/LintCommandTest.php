...
bar';
    ...
    {
        $filename = tempnam(sys_get_temp_dir().'/framework-yml-lint-tests', 'sf-');
    ...
    {
        $this->files = array();
        @mkdir(sys_get_temp_dir().'/framework-yml-lint-tests');
    }
    ...
    protected function tearDown()
    {
        ...
        rmdir(sys_get_temp_dir().'/framework-yml-lint-tests');
    }
}
